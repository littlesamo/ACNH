**Note: below is based on the google doc by Paleh https://docs.google.com/document/d/1ARIQCUc5YVEd01D7jtJT9EEJF45m07NXhAm4fOpNvCs. What I did is adding the genetic analysis to the oringial guide. During the process I found out some of the by product flowers can be used to breed as well. I have noted the findings in genetic analysis as well**
